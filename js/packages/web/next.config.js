...
module.exports = withPlugins(plugins, {
  ...
  env: {
    ...
    NEXT_PUBLIC_HOLAPLEX_TREASURY_PUBKEY: process.env.REACT_APP_HOLAPLEX_TREASURY_PUBKEY,
    NEXT_PUBLIC_HOLAPLEX_TREASURY_SPLIT: process.env.REACT_APP_HOLAPLEX_TREASURY_SPLIT,
    NEXT_PUBLIC_HOLAPLEX_TREASURY_APPROVE_ENDPOINT:
        process.env.REACT_APP_HOLAPLEX_TREASURY_APPROVE_ENDPOINT,
  },
  async rewrites() {
    return [
      {
