...
export async function getServerSideProps(context: NextPageContext) {
  ...
  const storefront = {
    subdomain: 'localhost',
    pubkey: 'CPmwTD4DKM8A1u4RCMQwVpR5k7GJDS6JcJGBiAoCs1Ym',
    theme: {
      logo: 'https://pbs.twimg.com/profile_images/1372153176158130182/MjRD1Bew_400x400.jpg',
      banner: '',
      stylesheet: 'https://arweave.cache.holaplex.dev/HATUEPf5cIR2ZtImLEGMSTKMJhKoaQoSFyy_BvyUYqI',
      color: { background: '#000', primary: '#f03e92' },
      font: { title: 'Nunito Sans', text: 'Nunito Sans' }
    },
    meta: {
      favicon: 'https://pbs.twimg.com/profile_images/1372153176158130182/MjRD1Bew_400x400.jpg',
      title: 'Holaplex - localhost | NFT Marketplace',
      description: 'A NFT marketplace generated by Holaplex'
    }
  }
